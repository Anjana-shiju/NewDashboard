...
export const SupportTicketsCard = () => {
  ...
  <button 
    /* appearance-none ഡിഫോൾട്ട് ബ്രൗസർ സ്റ്റൈലുകളെ ഇല്ലാതാക്കും */
    className="text-[#22AD5C] text-[12px] font-bold hover:underline appearance-none border-none outline-none p-0"
    style={{ background: 'none', boxShadow: 'none' }} // ഇൻലൈൻ സ്റ്റൈൽ വഴി ബോക്സ് പൂർണ്ണമായും ഒഴിവാക്കി
  >
    View All
  </button>
</div>
      ...
      <div className="flex flex-col gap-3">
        {tickets.map((ticket, index) => (
          <div key={index} className="flex items-center justify-between">
            ...
            {/* Arrow Button - നിങ്ങൾ തന്ന പുതിയ SVG ഇവിടെ ചേർത്തു */}
            <div 
              className="flex items-center justify-center shrink-0"
              style={{ 
                width: '40.11px',           /* */
                height: '32px',             /* */
                backgroundColor: 'rgba(243, 156, 18, 0.2)', /* #F39C12 20% */
                borderRadius: '25px'        /* */
              }}
            >
              <svg width="18" height="9" viewBox="0 0 18 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
                  ...
                  fill="#1A2D42" /* ബ്ലാക്കിന് പകരം കടും നീല നിറം നൽകി */
                />
              </svg>
            </div>
          </div>
