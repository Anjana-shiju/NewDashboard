  ...
  return (
    <>
      ...
      `}>
        ...
        <div className="mb-8 px-0 flex justify-between items-center">
          <img src={LogoImage} alt="Logo" className="h-24 w-auto object-contain" />
          
          {/* 2. onClose prop ivide call cheyyunnu */}
          <button className="lg:hidden text-gray-400 p-2 hover:bg-gray-50 rounded-full" onClick={onClose}>
